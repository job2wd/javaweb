...
public class Base64Utils {
  ...
  public static void encodeBytesToWriter(byte[] source, Writer writer) {
    try {
      encodeBytesToWriter(source, 0, source.length, Base64Utils.NO_OPTIONS, writer);
    } catch (IOException ex) {
      throw new RuntimeException("IOExceptions only come from GZipping, which is turned off: " + ex.getMessage(), ex);
    }
  }
  ...
  public static byte[] decodeFromFile(String filename) throws java.io.IOException {
    ...
    try {
      ...
      // Open a stream
      bis = new Base64Utils.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64Utils.DECODE);
  ...
  public static String encodeFromFile(String filename) throws java.io.IOException {
    ...
    try {
      ...
      // Open a stream
      bis = new Base64Utils.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64Utils.ENCODE);
