/*
 * $Id: Docx4jUtils.java 137 2017-02-06 06:17:06Z job2wd $
 * $HeadURL: http://code.taobao.org/svn/job2wd/javaweb/javaweb-showcase/src/main/java/org/javaweb/showcase/util/Docx4jUtils.java $
 ...
 * 
 * @author wangwd
 * @version $Revision: 137 $, $Date: 2016-10-11 下午5:34:00$
...
public class Docx4jUtils {
  ...
  private static Ftr getFtr(WordprocessingMLPackage wordPackage,Part sourcePart , String code) throws Exception {
      ...
      byte[] bt = null;//generateCode39Barcode(code);
  ...
  */
  ...
  public static void main(String[] args) {
    try {
      WordprocessingMLPackage mlpackage = Docx4jUtils.createWordprocessingMLPackage();
