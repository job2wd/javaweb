/*
 * $Id: FbaIpTools.java 3486 2017-03-30 04:39:14Z wangweidong $
 * $HeadURL: https://192.168.1.91/svn/FBA_WEB/trunk/prismtech-GLA-DP/src/main/java/com/prismtech/fba/utils/FbaIpTools.java $
 ...
 * @version $Revision: 3486 $, $Date: 2015-7-9 下午2:12:14$
 * @LastChanged $Author: wangweidong $, $Date:: 2017-03-30 12:39:14#$
 */
public class FbaIpTools {
   ...
   * @return
   */
  public static String getIpv4(List<IpRange> ipRanges){
    if(ipRanges == null) {
      return null;
    }
   ...
   * String
   */
  public static String getIpNumber(List<IpRange> ipRanges){
    if(ipRanges == null) {
      return null;
    }
  ...
  public static long getIpSize(List<IpRange> ipRanges){
    if(ipRanges == null) {
      return 0;
    }
   ...
   * @return
   */
  public static boolean isIpRange1InIpRange2(List<IpRange> range1, List<IpRange> range2) {
    for(IpRange r1 : range1) {
      for(IpRange r2 : range2) {
  ...
  public static boolean isCLANIP(long ip, String ipRange) {
    ...
    String ipStr = FbaIpTools.getIpv4(ip);
    String[] ipStrArray = ipStr.split("[.]");
    
    for(IpRange r : ipRangeList) {
      String[] startIpArray = FbaIpTools.getIpv4(r.getStartIp()).split("[.]");
      String[] endIpArray = FbaIpTools.getIpv4(r.getEndIp()).split("[.]");
