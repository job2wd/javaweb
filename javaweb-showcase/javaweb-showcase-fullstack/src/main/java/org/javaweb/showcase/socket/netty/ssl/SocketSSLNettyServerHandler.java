 ...
 */
public class SocketSSLNettyServerHandler extends SimpleChannelInboundHandler<String> {

  private static final Logger logger   = Logger.getLogger(SocketSSLNettyServerHandler.class.getName());
