...
function Log (level, logger, prefix) {
  ...
  this.isDebugEnabled = function () {
    return this.getLevel() == Log.DEBUG;
  }
  this.isInfoEnabled = function () {
    return this.getLevel() == Log.INFO;
  }
  this.isWarnEnabled = function () {
    return this.getLevel() == Log.WARN;
  }
  this.isErrorEnabled = function () {
    return this.getLevel() == Log.ERROR;
  }
  this.isFatalEnabled = function () {
    return this.getLevel() == Log.FATAL;
  }
}
/**
...
Log.popupLogger = function(msg,level,obj) {
	...
	return;
       ...
       if (!obj._window || !obj._window.document) {
               obj._window = window.open("",'logger_popup_window','width=820,height=420,scrollbars=1,status=0,toolbars=0,resizable=1');
