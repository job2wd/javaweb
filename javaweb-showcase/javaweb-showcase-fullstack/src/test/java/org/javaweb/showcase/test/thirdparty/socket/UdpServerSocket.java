package org.javaweb.showcase.test.thirdparty.socket;
...
public class UdpServerSocket {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
          received = udpServerSocket.receive();
          
          if(!"exit".equals(received)) {
            udpServerSocket.response("你好, [" + received + "] !");
          } else {
            udpServerSocket.response("你好, [" + received + "]， 服务端即将退出.... !");
            Thread.sleep(1000);
            break;
          }
        }
