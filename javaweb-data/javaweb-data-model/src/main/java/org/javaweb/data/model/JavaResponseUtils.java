 ...
 */
package org.javaweb.data.model;
...
public class JavaResponseUtils {
  ...
  public static ResponseBean4Validation createValidationResponseBean4Failed(String code, String message, String targetName,
    ...
    response4View.setCode(code);//JavaWebUtils.getI18nMessageSource().getMessage(code));
    response4View.setMessage(message);//JavaWebUtils.getI18nMessageSource().getMessage(message, messageArgs));
