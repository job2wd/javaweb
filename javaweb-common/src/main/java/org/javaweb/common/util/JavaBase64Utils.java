...
public class JavaBase64Utils {
  ...
  /** Maximum line length (64) of Base64 output. */
  ...
  private static void encode3to4(byte[] source, int srcOffset, int numSigBytes, Writer writer, int options) throws IOException {
    ...
    switch (numSigBytes) {
    case 3:
      writer.write((char) ALPHABET[(inBuff >>> 18)]);
      writer.write((char) ALPHABET[(inBuff >>> 12) & 0x3f]);
      writer.write((char) ALPHABET[(inBuff >>> 6) & 0x3f]);
      writer.write((char) ALPHABET[(inBuff) & 0x3f]);
      return;
  ...
  public static void encode(ByteBuffer raw, ByteBuffer encoded) {
    ...
    while (raw.hasRemaining()) {
      ...
      raw.get(raw3, 0, rem);
      JavaBase64Utils.encode3to4(enc4, raw3, rem, JavaBase64Utils.NO_OPTIONS);
      encoded.put(enc4);
    } // end input remaining
  }
   ...
   *          Specified options
   * @return The Base64-encoded object
   * @see JavaBase64Utils#GZIP
   * @see JavaBase64Utils#DO_BREAK_LINES
   * @throws java.io.IOException
   *           if there is an error
   * @since 2.0
   */
  public static String encodeObject(java.io.Serializable serializableObject, int options) throws java.io.IOException {
    ...
    try {
      ...
      b64os = new JavaBase64Utils.OutputStream(baos, ENCODE | options);
  ...
  public static byte[] encodeBytesToBytes(byte[] source) {
    byte[] encoded = null;
    try {
      encoded = encodeBytesToBytes(source, 0, source.length, JavaBase64Utils.NO_OPTIONS);
    } catch (IOException ex) {
      throw new RuntimeException("IOExceptions only come from GZipping, which is turned off: " + ex.getMessage(), ex);
    }
    return encoded;
  }
  ...
  public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options) throws java.io.IOException {
    ...
    if (off + len > source.length) {
      throw new IllegalArgumentException("Cannot have offset of " + off + " and length of " + len + " with array of length "
          + source.length);
    } // end if: off < 0
    ...
    if ((options & GZIP) > 0) {
      ...
      JavaBase64Utils.OutputStream b64os = null;
  ...
  public static void encodeBytesToWriter(byte[] source, Writer writer) {
    try {
      encodeBytesToWriter(source, 0, source.length, JavaBase64Utils.NO_OPTIONS, writer);
    } catch (IOException ex) {
      throw new RuntimeException("IOExceptions only come from GZipping, which is turned off: " + ex.getMessage(), ex);
    }
  }
  ...
  public static byte[] decode(byte[] source) {
    byte[] decoded = null;
    try {
      decoded = decode(source, 0, source.length, JavaBase64Utils.NO_OPTIONS);
  ...
  public static byte[] decode(byte[] source, int off, int len, int options) throws RuntimeException {
    ...
    if (off < 0 || off + len > source.length) {
      throw new IllegalArgumentException("Source array with length " + source.length + " cannot have offset of " + off + " and process "
          + len + " bytes.");
    } // end if
  ...
  public static void encodeToFile(byte[] dataToEncode, String filename) throws java.io.IOException {
    ...
    JavaBase64Utils.OutputStream bos = null;
    try {
      bos = new JavaBase64Utils.OutputStream(new java.io.FileOutputStream(filename), JavaBase64Utils.ENCODE);
  ...
  public static void decodeToFile(String dataToDecode, String filename) throws java.io.IOException {
    ...
    JavaBase64Utils.OutputStream bos = null;
    try {
      bos = new JavaBase64Utils.OutputStream(new java.io.FileOutputStream(filename), JavaBase64Utils.DECODE);
  ...
  public static byte[] decodeFromFile(String filename) throws java.io.IOException {
    ...
    JavaBase64Utils.InputStream bis = null;
    try {
      ...
      // Open a stream
      bis = new JavaBase64Utils.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), JavaBase64Utils.DECODE);
  ...
  public static String encodeFromFile(String filename) throws java.io.IOException {
    ...
    try {
      ...
      // Open a stream
      bis = new JavaBase64Utils.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), JavaBase64Utils.ENCODE);
      ...
      // Save in a variable to return
      encodedData = new String(buffer, 0, length, JavaBase64Utils.PREFERRED_ENCODING);
  ...
  public static void encodeFileToFile(String infile, String outfile) throws java.io.IOException {
    ...
    String encoded = JavaBase64Utils.encodeFromFile(infile);
  ...
  public static void decodeFileToFile(String infile, String outfile) throws java.io.IOException {
    ...
    byte[] decoded = JavaBase64Utils.decodeFromFile(infile);
    java.io.OutputStream out = null;
    try {
      out = new java.io.BufferedOutputStream(new java.io.FileOutputStream(outfile));
      out.write(decoded);
  ...
  /**
   * A {@link JavaBase64Utils.InputStream} will read data from another
  ...
  public static class InputStream extends java.io.FilterInputStream {
    ...
    /**
     * Constructs a {@link JavaBase64Utils.InputStream} in DECODE mode.
     * 
     * @param in
    ...
    /**
     * Constructs a {@link JavaBase64Utils.InputStream} in either ENCODE or DECODE mode.
     * <p>
     * Valid options:
     * 
     * <pre>
     ...
     * @param options
     *          Specified options
     * @see JavaBase64Utils#ENCODE
     * @see JavaBase64Utils#DECODE
     * @see JavaBase64Utils#DO_BREAK_LINES
     * @since 2.0
     */
  ...
  /**
   * A {@link JavaBase64Utils.OutputStream} will write data to another
  ...
  public static class OutputStream extends java.io.FilterOutputStream {
    ...
    /**
     * Constructs a {@link JavaBase64Utils.OutputStream} in ENCODE mode.
     * 
     * @param out
    ...
    /**
     * Constructs a {@link JavaBase64Utils.OutputStream} in either ENCODE or DECODE mode.
     * <p>
     * Valid options:
     * 
     * <pre>
      ...
      // Else, Decoding
        ...
        if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
          ...
          if (position >= bufferLength) { // Enough to output.
            ...
            int len = JavaBase64Utils.decode4to3(buffer, 0, b4, 0, options);
            out.write(b4, 0, len);
            position = 0;
          } // end if: enough to output
